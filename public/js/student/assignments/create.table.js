            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row, meta) {
                        if (row.selected === true) {
                            ...
                            return '<div class="form-check float-end mt-1"><input type="checkbox" checked class="form-check-input" value="'+row.id+'" name="student_id"></div>';
                        } else {
                            return '<div class="form-check float-end mt-1"><input type="checkbox" class="form-check-input" value="'+row.id+'" name="student_id"></div>';
                        }
                    },
                },
            ],
