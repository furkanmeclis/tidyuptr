        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <div class="card mb-5">
                        <div class="card-body">
                            <form id="userSettings" action="{{route("student.settings")}}">
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Tc Numaranız</label>
                                    <div class="col-sm-8 col-md-9 col-lg-10">
                                        <input type="tel" name="identity_number" class="form-control" value="{{$user->identity_number}}">
                                    </div>
                                </div>
                                <div class="mb-3 row">
