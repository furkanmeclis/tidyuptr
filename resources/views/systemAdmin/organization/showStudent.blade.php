...
@section('js_page')
    ...
    <script src="/js/systemAdmin/students/all.js"></script>
    <script src="/js/systemAdmin/students/helper.js"></script>
@endsection
                ...
                <div class="page-title-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <h1 class="mb-0 pb-0 display-4" id="title">{{ $organization->name }} Adlı Kurumdaki Öğrenciler</h1>
                        ...
                        <table id="datatableRows" class="data-table">
                            ...
                            @foreach ($students as $student)
                                <tr>
                                    ...
                                    <td><a href="{{ route('systemAdmin.student.show', $student->id) }}"
                                        ...
                                        </a> <a href="{{ route('systemAdmin.student.exam', $student->id) }}"
                                        ...
                                        </a> <a href="{{ route('systemAdmin.student.edit', $student->id) }}"
                                        ...
                                        </a> <a href="{{ route('systemAdmin.student.destroy', $student->id) }}"
