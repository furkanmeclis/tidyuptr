@php
    ...
    $breadcrumbs = [
        ...
        $organization ? route('systemAdmin.organization.showExams',$organization->id) : route('systemAdmin.organization.index') => 'Sınav Grupları',
        $batch ? route('systemAdmin.organization.showExams',$batch->id) : route('systemAdmin.organization.index') => 'Sınav Grubu Görüntüle',
        ];
@endphp
            ...
            <div class="col">
                @if($organization)
                        ...
                        <div class="page-title-container">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-12">
                                    <h1 class="mb-0 pb-0 display-4" id="title">{{$batch->name}} Adlı Sınava Ait Sonuçlar</h1>
                            ...
                            <div class="data-table-responsive-wrapper">
                                <table id="datatableRows" class="data-table">
                                    ...
                                    @foreach ($exams as $exam)
                                        ...
                                        <tr>
                                            <td>{{ $exam->id }}</td>
                                            <td><a href="{{route('systemAdmin.student.show',$student->id)}}">{{ $student->name }}</a></td>
                                            <td>{{ $exam->date() }}</td>
                                            <td>

                                                <a
                                                    href="{{ route('systemAdmin.exam.show', $exam->id) }}"
                                                ...
                                                </a> <a href="{{ route('systemAdmin.exam.destroy', $exam->id) }}"
                    ...
                    @else
                        ...
                        <div class="alert alert-warning">Görüntülenecek Kayıt Bulunamadı Sınav Grupları Sayfası İçin <a
                                href="{{ route('systemAdmin.organization.showExams',$organization->id) }}">Tıklayın</a>.</div>
                    @endif
                @else
                    <h2 class="small-title h1 mb-5">Kayıt Bulunamadı</h2>
