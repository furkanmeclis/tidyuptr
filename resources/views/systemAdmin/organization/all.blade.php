@php
    ...
    $breadcrumbs = [route('systemAdmin.index') => 'Anasayfa', route('systemAdmin.organization.index') => 'Kurumlar'];
@endphp
...
@section('js_page')
    ...
    <script src="/js/systemAdmin/organizations/all.js"></script>
                                ...
                                @foreach ($organizations as $organization)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('systemAdmin.organization.show', $organization->id) }}"
                                                ...
                                                data-bs-toggle="tooltip" data-bs-placement="top" title="Lisans Kayıtları"
                                                type="button">
                                                <i data-acorn-icon="calendar"></i>
                                            </a> <a href="{{ route('systemAdmin.organization.edit', $organization->id) }}"
