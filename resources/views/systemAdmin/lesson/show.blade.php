...
@section('js_page')
    <script src="/js/systemAdmin/lesson/show.js"></script>
    <script src="/js/systemAdmin/lesson/helper.js"></script>
@endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-7">
                            <h1 class="mb-0 pb-0 display-4" id="title"
                                data-add-url="{{ route('systemAdmin.lesson.storeTopic', $lesson->id) }}"
                                data-edit-url="{{ route('systemAdmin.lesson.updateTopic', ['lesson' => $lesson->id, 'topic' => 'randomTopicId']) }}"
                                data-trash-url="{{ route('systemAdmin.lesson.destroyTopic', 'randomTopicId') }}">
                                {{ $lesson->name }} Adlı Derse Ait Konular</h1>
                        ...
                        <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                            ...
                            <div class="btn-group ms-1 check-all-container">
                                ...
                                <button type="button" class="btn btn-outline-primary disabled delete-datatable"><i
                ...
                <div class="data-table-rows slim">
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                            <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
                                ...
                                <button class="btn btn-icon btn-icon-only btn-foreground-alternate shadow add-datatable"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Ekle" type="button"
                                    data-bs-delay="0">
                                    <i data-acorn-icon="plus"></i>
                                </button>
                                <!-- Add Button End -->
                                ...
                                <button
                                    ...
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Düzenle" type="button"
                                    data-bs-delay="0">
                                ...
                                <button
                                    ...
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Sil" type="button"
                                    data-bs-delay="0">
                    ...
                    <div class="data-table-responsive-wrapper">
                        <table id="datatableRows" class="data-table">
                            <thead>
                                <tr>
                                    <th class="text-small text-muted text-uppercase">Konu Id</th>
                                    <th class="text-small text-muted text-uppercase">Konu Adı</th>
                                    <th class="text-muted text-small text-uppercase">Konu Katsayısı</th>
                                    <th class="empty">&nbsp;</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($lesson->topics()->get() as $topic)
                                    <tr id="{{ $topic->id }}">
                                        <td class="text-start">{{ $topic->id }}</td>
                                        <td>{{ $topic->name }}</td>
                                        <td>{{ $topic->coefficient }}</td>
                                        <td></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalTitle">Yeni Konu Ekle</h5>
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Konu Katsayısı</label>
                                            <input name="coefficient" type="number" class="form-control" />
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                        id="addEditConfirmButton">Ekle</button>
                                </div>
                            </div>
                        </div>
                    </div>
