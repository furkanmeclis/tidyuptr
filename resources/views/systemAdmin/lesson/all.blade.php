...
@section('js_page')
    ...
    <script src="/js/systemAdmin/lesson/all.js"></script>
                ...
                <div class="data-table-rows slim">
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                            ...
                            <div class="d-inline-block">
                                ...
                                <a href="{{ route('systemAdmin.lesson.create') }}"
                                    ...
                                    title="Yeni Öğretmen Ekle" type="button">
                    ...
                    <div class="data-table-responsive-wrapper">
                        <table id="datatableRows" class="data-table">
                            <thead>
                                <tr>
                                    <th class="text-small text-muted text-uppercase">Ders Id</th>
                                    <th class="text-small text-muted text-uppercase">Ders Adı</th>
                                    <th class="text-small text-muted text-uppercase">Sınıf</th>
                                    <th class="text-muted text-small text-uppercase">Konu Sayısı</th>
                                    <th class="empty">&nbsp;</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($lessons as $lesson)
                                    <tr>
                                        <td class="text-start">{{ $lesson->id }}</td>
                                        <td>{{ $lesson->name }}</td>
                                        <td>{{ $lesson->grade }}</td>
                                        <td>{{ $lesson->topics()->count() }}</td>
                                        <td class="text-end"><a href="{{ route('systemAdmin.lesson.show', $lesson->id) }}"
                                            ...
                                            </a> <a href="{{ route('systemAdmin.lesson.edit', $lesson->id) }}"
                                            ...
                                            <a href="{{ route('systemAdmin.lesson.destroy', $lesson->id) }}"
                                                class="btn  mb-1 btn-sm btn-icon btn-icon-only btn-danger shadow delete-lesson-btn"
