                        ...
                        <div class="col-md-3 mb-5">
                            ...
                            <div class="row g-2">
                                <div class="col-12">
                                    <div class="card h-100 hover-scale-up">
                                        <a class="card-body text-center"
                                            href="{{ route('systemAdmin.student.edit', $student->id) }}">
                                ...
                                <div class="col-12">
                                    <div class="card h-100 hover-scale-up">
                                        <a class="card-body text-center"
                                            href="{{ route('systemAdmin.student.edit', $student->id) }}#updatePassword">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="row g-2">
                                <div class="col-6 col-xl-6 sh-19">
                                    <div class="card h-100 hover-scale-up">
                                        <a class="card-body text-center"
                                            href="{{ route('systemAdmin.student.exam',$student->id) }}">
                                ...
                                <div class="col-6 col-xl-6 sh-19">
                                    <div class="card h-100 hover-scale-up">
                                        <a class="card-body text-center"
                                            href="{{ route('systemAdmin.teacher.show', $teacher_id->id) }}">
