@php
    ...
    $breadcrumbs = [
        ...
        route('systemAdmin.student.create') => 'Yeni Öğrenci Ekle',
    ];
@endphp
...
@endsection
@section('js_page')
    <script src="/js/systemAdmin/students/create.js"></script>
    <script src="/js/systemAdmin/students/create.table.js"></script>
@endsection
@section('content')
    <div class="container">
        <div class="row">
                ...
                <div class="mb-5 wizard" id="studentWizard">
                        ...
                        <ul class="nav nav-tabs justify-content-center" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-center" href="#basicFirst" role="tab">
                                    <div class="mb-1 title d-none d-sm-block">Kurum Seçimi</div>
                                    <div class="text-small description d-none d-md-block">Öğrencinin Ekleneceği Kurum</div>
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content mt-5 mb-5">
                            ...
                            <div class="data-table-rows slim">
                                ...
                                <div class="data-table-responsive-wrapper">
                                    <table id="datatableRows" class="data-table"
                                        data-ajax-url="{{ route('systemAdmin.organization.getOrganizations') }}">
                                        <thead>
                                            <tr>
                            ...
                            <div class="data-table-rows slim">
                                ...
                                <div class="data-table-responsive-wrapper">
                                    <table id="datatableRows2" class="data-table"
                                        data-ajax-url="{{ route('systemAdmin.teacher.getTeachers') }}">
                                        <thead>
                                            <tr>
                                                <th class="text-muted text-uppercase">#Id</th>
                        ...
                        <div class="tab-pane fade" id="basicThird" role="tabpanel">
                            <div class="card">
                                <div class="card-body">
                                    <form id="createStudent" action="{{ route('systemAdmin.student.store') }}"
