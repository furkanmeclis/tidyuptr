                            ...
                            @foreach ($schemes as $scheme)
                                <tr>
                                    ...
                                    <td><a href="#" data-bs-toggle="modal" data-bs-target="#showScheme-{{ $scheme->id }}"
                                        ...
                                        </a> <a href="{{ route('systemAdmin.optic.destroy', $scheme->id) }}"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('systemAdmin.optic.downloadFmt',$scheme->id)}}?reader=sekonic" type="button" class="btn btn-gradient-primary">İndir(Sekonic)</a>
                                    </div>
                                </div>
                            </div>
                        </div>
