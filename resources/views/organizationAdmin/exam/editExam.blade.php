@php
    ...
    $breadcrumbs = [
        ...
        $exam ? route('organizationAdmin.batchExam.exam.edit', ["exam" => $batch->id,"examId"=>$exam->id]) : route('organizationAdmin.batchExam.show',$batch->id) => 'Sınavı Düzenle',
    ];
@endphp
...
@endsection
@section('js_page')
    <script src="/js/organizationAdmin/exams/edit.js"></script>
@endsection
@section('content')
    <div class="container">
        <div class="row">
            <div class="col">
                @if ($exam)
                    ...
                    <div>
                        <form id="updateExamResult"
                              action="{{ route('organizationAdmin.batchExam.exam.update', ["exam" => $batch->id,"examId"=>$exam->id]) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center mt-3">
                                    ...
                                    <a class="btn btn-dark me-3" href="{{route('organizationAdmin.batchExam.show',$batch->id)}}">Vazgeç</a><button class="btn btn-primary" type="submit">Güncelle</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                @else
                    ...
                    <div class="alert alert-warning">Sınav Bulunamadı Sınavlar Sayfası İçin <a
                            href="{{ route('organizationAdmin.exam.index') }}">Tıklayın</a>.</div>
                @endif
            </div>
        </div>
    </div>
