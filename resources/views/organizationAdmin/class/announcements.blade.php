    ...
    @endif
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink-{{$content->id}}" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 21px);" data-popper-placement="bottom-start">
                                                <a class="dropdown-item text-danger delete-content-btn" href="{{route('organizationAdmin.class.announcement.destroy',[
                                                "class" => $class_id,
                                                "ann" => $content->id
                                                ])}}">
                                                    Sil
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <form id="createMessage" action="{{route('organizationAdmin.class.announcement.store',$class_id)}}">
