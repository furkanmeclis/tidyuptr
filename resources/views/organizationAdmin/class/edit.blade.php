...
@endsection
@section('js_page')
    <script src="/js/organizationAdmin/class/edit.table.js"></script>
    <script src="/js/organizationAdmin/class/edit.js"></script>
@endsection
@section('content')
    <div class="container">
        <div class="row">
                ...
                <div class="mb-5 wizard" id="classWizard">
                    ...
                    <div class="tab-content mt-5 mb-5">
                            ...
                            <div class="data-table-rows slim">
                                ...
                                <div class="data-table-responsive-wrapper">
                                    <table id="datatableRows2" class="data-table"
                                           data-ajax-url="{{ route('organizationAdmin.class.getStudentsClass',$class->id) }}">
                                        <thead>
                                        <tr>
                        ...
                        <div class="tab-pane fade" id="basicThird" role="tabpanel">
                            <div class="card">
                                <div class="card-body">
                                    <form id="createClass" action="{{ route('organizationAdmin.class.update',$class->id) }}"
                                          method="POST" class="tooltip-end-bottom" novalidate>
                                        <div class="mb-3 filled ">
                                            <i data-acorn-icon="online-class"></i>
                                            <input class="form-control" placeholder="Sınıf Adı" name="name" value="{{$class->name}}" />
