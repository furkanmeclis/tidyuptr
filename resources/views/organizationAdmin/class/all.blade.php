                        ...
                        <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                            ...
                            <div class="d-inline-block">
                                ...
                                <a href="{{ route('organizationAdmin.class.create') }}"
                                   ...
                                   title="Yeni Sınıf Ekle" type="button">
                        ...
                        <table id="datatableRows" class="data-table">
                            ...
                            @foreach ($classes as $class)
                                <tr>
                                    ...
                                    <td><a href="{{ route('organizationAdmin.class.show', $class->id) }}"
                                        ...
                                        </a> <a href="{{ route('organizationAdmin.class.destroy', $class->id) }}"
                                                class="btn  mb-1 btn-sm btn-icon btn-icon-only btn-danger shadow delete-class-btn"
