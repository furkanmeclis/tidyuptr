                    ...
                    <div class="data-table-responsive-wrapper">
                        <table id="datatableRows" class="data-table">
                            ...
                            <tr>
                                ...
                                <th class="text-muted text-uppercase">Ders Sayısı</th>
                                <th class="text-muted text-uppercase">Sınıf</th>
                                <th class="empty">&nbsp;</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach ($schemes as $scheme)
                                <tr>
                                    <td>{{ $scheme->name }}</td>
                                    <td>{{ count(json_decode($scheme->lesson_ids,true)) }}</td>
                                    <td>{{ $scheme->grade }}</td>
                                    <td><a href="#" data-bs-toggle="modal" data-bs-target="#showScheme-{{ $scheme->id }}"
                                        ...
                                        </a> <a href="{{ route('organizationAdmin.examScheme.edit', $scheme->id) }}"
                                        ...
                                        </a> <a href="{{ route('organizationAdmin.examScheme.destroy', $scheme->id) }}"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title">{{$scheme->name}} Adlı Şemaya Ait Dersler</h3>
                                        ...
                                        <div class="modal-body">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    @foreach($scheme->lessons() as $lesson)
                                                        <tr>
                                                            <td>{{$lesson->id}}</td>
                                                            <td>{{$lesson->name}}</td>
                                                            <td>{{$lesson->grade}}</td>
