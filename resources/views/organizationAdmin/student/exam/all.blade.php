@php
    ...
    $breadcrumbs = [
        ...
        $student ? route('organizationAdmin.student.show',$student->id) : '#' =>'Öğrenciyi Görüntüle',
        $student ? route('organizationAdmin.student.exam.index',$student->id) : '#' => 'Sınavlar',
        ];
@endphp
                            ...
                            @foreach ($exams as $exam)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a
                                            href="{{ route('organizationAdmin.student.exam.show', [
    "student" => $student->id,
    "exam" => $exam->id,
]) }}"
                                            ...
                                            href="{{ route('organizationAdmin.student.exam.analysis', [
                                                                                                        "student" => $student->id,
    "exam" => $exam->id,
                                                                                                    ]) }}"
                                            ...
                                            href="{{ route('organizationAdmin.student.exam.downloadPdf', [
    "student" => $student->id,
    "exam" => $exam->id,
]) }}"
                                            ...
                                            href="{{ route('organizationAdmin.student.exam.edit', [
    "student" => $student->id,
    "exam" => $exam->id,
]) }}"
                                        ...
                                        </a> <a href="{{ route('organizationAdmin.student.exam.destroy', [
    "student" => $student->id,
    "exam" => $exam->id,
]) }}"
