                ...
                @if ($exam)
                    ...
                    <div>
                        <form id="updateExamResult"
                              action="{{ route('organizationAdmin.student.exam.update', ["student" => $student->id,"exam"=>$exam->id]) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center mt-3">
                                    ...
                                    <a class="btn btn-dark me-3" href="{{route('organizationAdmin.student.exam.index',$student->id)}}">Vazgeç</a><button class="btn btn-primary" type="submit">Güncelle</button>
                                </div>
                            </div>
                        </form>
                    </div>
