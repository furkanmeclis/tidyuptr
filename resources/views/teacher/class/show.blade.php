...
@section('js_page')
    ...
    <script src="/js/teacher/class/helper.js"></script>
    <script>
    ...
    <div class="container">
        <div class="row">
            ...
            @if($class)
                ...
                <h3 class="small-title h1 mb-3">{{$class->name}} - {{\App\Models\Organization::find($class->organization_id)->name}}</h3>
                                            ...
                                            <div class="card mb-5">
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    @if($exam = $student->lastExam())
                                                        ...
                                                        <div href="{{route('teacher.class.showExam',$exam->id)}}" class="show-exam-btn cursor-pointer">
                ...
                @component('components.timetable',["timetable" => \App\Models\TimeTable::where('class_id',$class->id)->firstOrFail(),"teacher" => auth('teacher')->user()])@endcomponent
            ...
            @else
                ...
                <div class="alert alert-warning">Görüntülenecek Kayıt Bulunamadı Sınıflar Sayfası İçin <a
                        href="{{ route('teacher.class.index') }}">Tıklayın</a>.</div>
            @endif
        </div>
    </div>
@endsection
