        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <div class="card mb-5">
                        <div class="card-body">
                            <form id="userSettings" action="{{route("teacher.settings")}}">
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Canlı Ders Linkiniz</label>
                                    <div class="col-sm-8 col-md-9 col-lg-10">
                                        <input type="tel" name="live_lesson_url" class="form-control" value="{{$user->live_lesson_url}}">
                                    </div>
                                </div>
                                <div class="mb-3 row">
