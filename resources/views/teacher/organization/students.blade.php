@php
    ...
    $breadcrumbs = [
        ...
        route('teacher.organization.index') => 'Kurumlar',
        $organization ? route('teacher.organization.student', $organization->id) : route('teacher.organization.index') => 'Öğrenciler',
    ];
@endphp
...
@section('js_page')
    ...
    <script src="/js/teacher/students/all.js"></script>
                    ...
                    <div class="data-table-responsive-wrapper">
                        <table id="datatableRows" class="data-table">
                            ...
                            <tr>
                                ...
                                <th class="text-muted text-uppercase">Kurumu</th>
                                <th class="empty">&nbsp;</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach ($students as $student)
                                <tr>
                                    <td>{{ $student->name }}</td>
                                    <td>{{ \App\Models\Organization::find($student->organization_id)->name }}</td>
                                    <td><a href="{{ route('teacher.student.show', $student->id) }}"
                                           ...
                                           title="Görüntüle" type="button">
                                        ...
                                        </a> <a href="{{ route('teacher.student.exam', $student->id) }}"
                                            ...
                                            <i data-acorn-icon="quiz"></i>
                                        </a> <a href="{{ route('teacher.student.destroy', $student->id) }}"
                                                ...
                                                title="Bağlantıyı Kaldır" type="button">
